...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert("Videos", [
      ...
      {
        embedURL:
          "https://www.youtube.com/watch?v=LembwKDo1Dk?rel=0&modestbranding=1",
      ...
      {
        embedURL:
          "https://www.youtube.com/watch?v=sclTMEd7JN8?rel=0&modestbranding=1",
        title: "Battlefield 4™",
      ...
      {
        embedURL:
          "https://www.youtube.com/watch?v=UMLwzt5t9bs?rel=0&modestbranding=1",
        title: "Astroneer",
        about: `A game of aerospace industry and interplanetary exploration.  `,
        genreId: 1,
        imageURL: "https://netsteambucket.s3.amazonaws.com/astro.jpg",
      ...
      {
        embedURL:
          "https://www.youtube.com/watch?v=ah6OVetEmFQ?rel=0&modestbranding=1",
        title: "Totally Accurate Battle Simulator",
        about: `Be the leader of wobblers from ancient lands, spooky places, and fantasy worlds. Watch them fight in simulations made with the wobbliest physics system ever created, make your own wobblers in the unit creator and send your army off to fight your friends in multiplayer. `,
        genreId: 6,
        imageURL: "https://netsteambucket.s3.amazonaws.com/tabs.jpg",
        developer: "Landfall",
        publisher: "Landfall",
      ...
      {
        embedURL:
          "https://www.youtube.com/watch?v=xjn66Cl3pMA?rel=0&modestbranding=1",
        title: "Crusader Kings III",
        about: `Paradox Development Studio brings you the sequel to one of the most popular strategy games ever made. Crusader Kings III is the heir to a long legacy of historical grand strategy experiences and arrives with a host of new ways to ensure the success of your royal house. `,
        genreId: 6,
        imageURL: "https://netsteambucket.s3.amazonaws.com/ck3.jpg",
